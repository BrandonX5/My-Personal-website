                ...
                <div class="right-about">
                    <div class="about-item">
                        <div class="abt-text">
                            ...
                            <p class="small-text">Years of <br /> Professional IT experience</p>
                        </div>
                    </div>
                    <div class="about-item">
                        <div class="abt-text">
                            <p class="large-text">~5</p>
                            <p class="small-text">Years of <br /> customer service experience</p>
                        </div>
                    </div>
                    <div class="about-item">
                        <div class="abt-text">
                            <p class="large-text">~3</p>
                            <p class="small-text">Years of <br />knowledge of the insurance industry</p>
                        </div>
                    </div>
                    <div class="about-item">
                        <div class="abt-text">
                            <p class="large-text">~4</p>
                            <p class="small-text">Years of <br /> knowledge of the construction industry</p>
                        </div>
                    </div>
                </div>
            </div>
